...
public class QuestionService {
	...
	public void init() {
		...
		lista.add(ans3);
		lista.add(ans4);
		Question q1 = new Question(0, "dove va ciccio", lista, "multiple");
		questions.add(q1);
		...
		Question q2 = new Question(1,
				"dove va ciccio nuova domanda dove va ciccio nuova domandadove va ciccio nuova domandadove va ciccio nuova domandadove va ciccio nuova domandadove va ciccio nuova domandadove va ciccio nuova domandadove va ciccio nuova domandadove va ciccio nuova domandadove va ciccio nuova domandadove va ciccio nuova domanda?",
				lista2, "multiple");
		questions.add(q2);
		List<Answer> lista3 = new ArrayList<>();
		Question q3 = new Question(2, "domanda aperta?", lista3, "open");
		questions.add(q3);
