...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/createExam", "/addQuestions", "/evalExam", "/checkExam", "/showExam").hasRole("Professor")
        .antMatchers("/exam", "/redirectExam", "/submitExam", "/goToExamDario", "/examList").hasRole("Student")
